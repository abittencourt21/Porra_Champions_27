...
def build_seed(csv_path: Path) -> dict:
    ...
    return {"meta": {"ultima_actualizacion": datetime.now(timezone.utc).isoformat(), "fuente": "UEFA 2026/27 (bombos); TheSportsDB 4480 (calendario/contraste)", "competition": "UEFA Champions League", "season": CHAMPIONS_SEASON, "source_uefa_url": UEFA_FIXTURES_URL, "source_uefa_pots_url": UEFA_POTS_URL, "source_sportsdb_csv": portable_source_reference(csv_path), "estado_torneo": "pre", "campeon": "", "subcampeon": "", "pichichi_nombre": "", "pichichi_goles": 0}, "bombos": uefa_champions_pots(), "participantes": [], "partidos": sorted(matches, key=lambda item: (item["roundnumber"], item["fecha"], item["matchid"])), "goleadores": []}
